...
export const ADMIN_PAGE_ROWS_BUTTON = "inline-flex h-9 items-center rounded-xl px-3 text-xs transition-colors";
export const ADMIN_PAGE_ROWS_BUTTON_ACTIVE = "admin-pill font-semibold";
export const ADMIN_PAGE_ROWS_BUTTON_IDLE = "admin-outline-button text-[hsl(var(--foreground)/0.75)]";
export const ADMIN_PAGE_PAGER = "flex items-center justify-end gap-2";
export const ADMIN_PAGE_PAGER_BUTTON = "admin-outline-button inline-flex h-9 items-center rounded-xl px-3 text-xs text-[hsl(var(--foreground)/0.78)]";
export const ADMIN_PAGE_PAGER_DISABLED = "admin-outline-button inline-flex h-9 items-center rounded-xl px-3 text-xs opacity-50";
export const ADMIN_PAGE_PAGER_CURRENT = "admin-pill inline-flex h-9 items-center rounded-xl px-3 text-xs font-semibold";
