      ...
      <div className={ADMIN_PAGE_STACK}>
        ...
        <PartnerRentalsClient
          ...
          rows={rows.map((row) => ({
            ...
            pickupFuelLevel: row.pickupFuelLevel,
            returnOdometerKm: row.returnOdometerKm,
            returnFuelLevel: row.returnFuelLevel,
            pickupChecklistDocumentUrl: row.pickupChecklistDocumentUrl,
            returnChecklistDocumentUrl: row.returnChecklistDocumentUrl,
            closeoutPaymentDueAt: row.closeoutPaymentDueAt ? row.closeoutPaymentDueAt.toISOString() : null,
            closeoutPaymentReceivedAt: row.closeoutPaymentReceivedAt ? row.closeoutPaymentReceivedAt.toISOString() : null,
            returnLateCharge: row.returnLateCharge,
            returnFuelCharge: row.returnFuelCharge,
            returnDamageCharge: row.returnDamageCharge,
