...
export default async function FAQPage({
  ...
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top,_hsl(var(--primary)/0.1),_transparent_52%),linear-gradient(180deg,_#f9fbff,_#ffffff_50%,_#fff9fc_74%,_#f8fbff)] pt-24 sm:pt-28">
      <div className="absolute inset-x-0 top-0 h-72 bg-[linear-gradient(180deg,hsl(var(--primary)/0.1),transparent)]" />
      <div className="absolute inset-y-0 left-0 w-72 bg-[radial-gradient(circle_at_left,hsl(192_90%_72%/0.12),transparent_62%)]" />
      <div className="absolute inset-y-0 right-0 w-72 bg-[radial-gradient(circle_at_right,hsl(var(--accent)/0.16),transparent_62%)]" />
      <div className="relative mx-auto max-w-7xl px-4 pb-12 pt-6 sm:px-6 sm:pt-8 lg:px-8 lg:pb-16">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.45fr)_360px] lg:items-start">
          <div className="space-y-8">
            <div className="overflow-hidden rounded-[2rem] border border-white/50 bg-[linear-gradient(135deg,rgba(255,255,255,0.74),hsl(var(--accent)/0.18)_42%,hsl(192_90%_75%/0.1)_100%)] p-8 shadow-[0_30px_90px_-46px_hsl(var(--foreground)/0.14)] ring-1 ring-white/60 backdrop-blur-xl sm:p-10">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/60 bg-[linear-gradient(135deg,rgba(255,255,255,0.68),hsl(var(--primary)/0.14))] px-4 py-2 text-xs font-semibold uppercase tracking-[0.32em] text-[hsl(var(--primary))] ring-1 ring-white/60 backdrop-blur-xl">
              ...
              <div className="mt-8 grid gap-4 md:grid-cols-3">
                {highlightedEntries.map((entry) => (
                  <div
                    key={entry.id}
                    className="rounded-[1.5rem] border border-white/55 bg-[linear-gradient(180deg,rgba(255,255,255,0.8),hsl(var(--accent)/0.22)_62%,hsl(192_90%_75%/0.08)_100%)] p-5 shadow-[0_18px_40px_-30px_hsl(var(--primary)/0.18)] ring-1 ring-white/55 backdrop-blur-xl"
                  >
            ...
            <div className="overflow-hidden rounded-[2rem] border border-white/50 bg-[linear-gradient(135deg,rgba(255,255,255,0.74),hsl(var(--primary)/0.06)_32%,hsl(var(--accent)/0.1)_72%,rgba(255,255,255,0.76))] p-5 shadow-[0_30px_90px_-48px_hsl(var(--foreground)/0.14)] ring-1 ring-white/60 backdrop-blur-xl sm:p-6">
          ...
          <aside className="lg:sticky lg:top-24">
            <div className="space-y-6">
              <div className="overflow-hidden rounded-[2rem] border border-white/50 bg-[linear-gradient(135deg,rgba(255,255,255,0.76),hsl(var(--accent)/0.16)_54%,hsl(192_90%_75%/0.08)_100%)] p-7 shadow-[0_28px_72px_-44px_hsl(var(--foreground)/0.14)] ring-1 ring-white/60 backdrop-blur-xl">
                ...
                <div className="mt-6 space-y-3">
                  <div className="rounded-[1.4rem] border border-white/55 bg-[linear-gradient(135deg,rgba(255,255,255,0.72),hsl(var(--accent)/0.12))] px-4 py-4 ring-1 ring-white/55 backdrop-blur-xl">
                  ...
                  <div className="rounded-[1.4rem] border border-white/55 bg-[linear-gradient(135deg,rgba(255,255,255,0.72),hsl(var(--primary)/0.1))] px-4 py-4 ring-1 ring-white/55 backdrop-blur-xl">
                    <div className="flex items-start gap-3">
                  ...
                  <div className="rounded-[1.4rem] border border-white/55 bg-[linear-gradient(135deg,rgba(255,255,255,0.72),hsl(192_90%_75%/0.1))] px-4 py-4 ring-1 ring-white/55 backdrop-blur-xl">
                    <div className="flex items-start gap-3">
