...
export default async function FAQPage({
  ...
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top,_hsl(var(--primary)/0.08),_transparent_52%),linear-gradient(180deg,_#fbfbfd,_#ffffff_55%,_#faf8fc)] pt-24 sm:pt-28">
