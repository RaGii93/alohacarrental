      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[var(--sidebar-width)] border-r border-[hsl(var(--sidebar-border))] bg-white p-0 text-[hsl(var(--sidebar-foreground))] shadow-[0_24px_80px_-32px_hsl(var(--primary)/0.2)] [&>button]:hidden"
            style={
              {
